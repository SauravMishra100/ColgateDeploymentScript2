const jsonString =
  HtmlService.createHtmlOutputFromFile("config.json.html").getContent();
...
function doGet(e) {
  ...
  var whiteList = SpreadsheetApp.openById(spreadsheetId)
...
//Return 2D array from sent spreadsheet data
function getData() {
...
//Return 2D array from saved spreadsheet data
function getSaveData() {
  var values = SpreadsheetApp.openById(spreadsheetId)
    .getSheetByName("Saved")
    .getDataRange()
    .getValues();
  console.log(values);
  return values;
